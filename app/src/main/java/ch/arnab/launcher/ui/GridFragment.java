...
public class GridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv.setColumnWidth(convertDpToPixels(120, getActivity()));
        lv.setStretchMode(GridView.STRETCH_COLUMN_WIDTH);
        lv.setNumColumns(GridView.AUTO_FIT);
        lv.setHorizontalSpacing(convertDpToPixels(30, getActivity()));
        lv.setVerticalSpacing(convertDpToPixels(30, getActivity()));
