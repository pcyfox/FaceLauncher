...
-keep public class * extends com.eims.yunke.service.IMService
...
-dontwarn androidx.**
-keep class ch.taike.launcher.entity.**
...
-keep class * implements android.os.Parcelable {
  ...
  # 保留我们自定义控件（继承自View）不被混淆
-keep  class * extends  com.qicloud.lib_common.application.AbstractApplication
