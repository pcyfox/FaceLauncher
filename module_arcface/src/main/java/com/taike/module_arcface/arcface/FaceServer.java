...
public class FaceServer {
     ...
     * 存放注册图的目录
     */
    public static final String SAVE_IMG_DIR = "registered" + File.separator + "imgs";
    /**
     * 存放特征的目录
     */
    private static final String SAVE_FEATURE_DIR = "registered" + File.separator + "features";
    ...
    public int clearAllFaces(Context context) {
        Log.d(TAG, "clearAllFaces() called with: context = [" + context + "]");
        synchronized (this) {
            if (context == null) {
                return 0;
            }
